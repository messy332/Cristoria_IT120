...
📱 **Scape** – Coffee Cup Detection App using Flutter & AI
...
const parminder = {
    pronouns: "He" | "Him",
    code: ["PHP", "JavaScript", "Python", "Java", "Dart", "HTML", "CSS"],
    currentlyWorking: ["Scape - Coffee Cup Detection App"],
    technologies: {
        frontEnd: {
    ...
    currentFocus: "Building mobile apps that solve real-world problems",
    funFact: "I turn coffee into code and ideas into working applications! ☕"
};
```
